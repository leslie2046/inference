const zh = {
  ...
  launchModel: {
    ...
    nGpuLayers: 'GPU 层数',
    replica: '副本',
    additionalReplicaCount: '新增副本数',
    replicaCountPreview: '当前 {{current}} 个 → 添加后 {{total}} 个',
    addReplica: '添加副本',
    deployDialogDescription: '配置并部署新的模型实例。',
    addReplicaDialogDescription: '复用当前模型配置，仅可调整新增副本数和 Worker、GPU 等资源配置。',
  ...
  runningModels: {
    ...
    replicaDetail: '副本详情',
    addReplica: '增加副本',
    addReplicaSuccess: '副本增加成功',
    addReplicaFailed: '副本增加失败',
